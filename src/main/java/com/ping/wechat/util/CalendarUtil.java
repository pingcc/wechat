...
public class CalendarUtil {
     ...
     * @throws Exception
     */
    public static void checkLunarDate(int lunarYear, int lunarMonth, int lunarDay, boolean leapMonthFlag)
        throws Exception {
    ...
    public static String solarToLunar(String solarDate) throws Exception {
        ...
        return lunarYear + "年" + (leapMonthFlag & (lunarMonth == leapMonth) ? "闰" : "") + lunarMonth + "月" + lunarDay
            + "日";
    }
    ...
    public static Date getCurrentYearBirthday(String type, Date birthday) throws Exception {
        ...
        if (org.apache.commons.lang.StringUtils.equalsIgnoreCase(type, "1")) {
            //如果是阳历生日，返回
            return SaafDateUtils.string2UtilDate(birthdayStr, SaafDateUtils.date_sdf.get());
        } else {
            //如果是阴历，则计算阳历生日
            //闰月
            ...
            return SaafDateUtils.string2UtilDate(solarDate, SaafDateUtils.yyyyMMdd.get());
        }
    }
